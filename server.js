...
const Sample = require('./models/post');
...
app.post('/entry/create', (req, res) => {
    ...
    let matchVenue = req.body.matchVenue;
    let matchReferee = req.body.matchReferee;
    let matchResult = req.body.matchResult;
    let matchStadiumType = req.body.matchStadiumType;
    let matchCapacity = req.body.matchCapacity;
    let matchNotes = req.body.matchNotes;
...
app.put('/entry/:id', function (req, res) {
    ...
    let updateableFields = ['entryType', 'inputDate', 'matchNotes', 'loggedInUserName'];
...
app.get('/entry-watch/:user', function (req, res) {
...
app.get('/entry-classic/:user', function (req, res) {
...
app.get('/entry-dramatic/:user', function (req, res) {
...
app.delete('/entry/:id', function (req, res) {
    Sample.findByIdAndRemove(req.params.id).exec().then(function (entry) {
        return res.status(204).end();
    }).catch(function (err) {
        return res.status(500).json({
            message: 'Internal Server Error'
